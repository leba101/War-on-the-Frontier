class CfgPatches
{
	class FT_Spitfire_MK1
	{
		units[] = {"FT_Spitfire_MK1_w"};
		weapons[] = {"FT_Spitfire_MK1"};
		requiRedVersion = 0.1;
		requiRedAddons[] = {"A3_Data_F","A3_Weapons_F"};
		magazines[] = {"FT_40Rnd_Spitfire_MK1_Mag","FT_40Rnd_HE_Spitfire_MK1_Mag"};
		ammo[] = {"FT_Spitfire_MK1_ammo","FT_Spitfire_MK1_ammo_HE"};
		author = "Leba";
	};
};
...
class CfgAmmo
{
	...
	class B_762x51_Ball;
	class FT_Spitfire_MK1_ammo:B_762x51_Ball
	{
		hit=6;
	};
};
class CfgMagazines
{
	...
	class CA_Magazine;
	class FT_14Rnd_Spitfire_MK1_Mag: CA_Magazine
	{
		author = "Leba";
		scope = 2;
		displayName = "14Rnd Spitfire_MK1 Mag";
		picture = "\A3\weapons_F\data\UI\m_20stanag_ca.paa";
		ammo = "FT_Spitfire_MK1_ammo";
		count = 14;
		type = 16;
		initSpeed = 800;
		mass = 8;
	...
	class FT_14Rnd_Spitfire_MK1_Mag_Tracer: FT_14Rnd_Spitfire_MK1_Mag
	{
		author = "Leba";
		scope = 2;
		displayName = "14Rnd Spitfire_MK1 Mag(Tracer)";
		picture = "\A3\weapons_F\data\UI\m_20stanag_ca.paa";
		ammo = "FT_Spitfire_MK1_ammo";
		tracersEvery = 0;
		lastRoundsTracer = 14;
...
class CfgWeapons
{
	...
	class FT_Spitfire_MK1: FT_Rifle_Base
	{
		scope = 2;
		author = "Leba";
		FT_Weapon = "Spitfire_MK1";
		FT_Ammo1 = "FT_14Rnd_Spitfire_MK1_Mag";
		FT_Ammo2 = "FT_14Rnd_Spitfire_MK1_Mag_Tracer";
		_generalMacro = "FT_Spitfire_MK1";
		model = "\War_on_the_Frontier\FT_Weapons\FT_Spitfire_MK1\FT_Spitfire_MK1.p3d";
		hiddenSelections[] = {"camo1"};
		hiddenSelectionsTextures[] = {"\War_on_the_Frontier\FT_Weapons\FT_Spitfire_MK1\data\ft_Spitfire_MK1_camo1_co.paa"};
		handAnim[] = {"OFP2_ManSkeleton","\War_on_the_Frontier\FT_Weapons\FT_Spitfire_MK1\animations\FT_Spitfire_MK1_Hold.rtm"};
		reloadAction = "GestureReloadDMR06";//needs to have one for itself but i don't have time to make it
		picture = "";
		magazines[] = {"FT_14Rnd_Spitfire_MK1_Mag","FT_14Rnd_Spitfire_MK1_Mag_Tracer"};
		displayname = "Spitfire_MK1";
		descriptionShort = "Spitfire_MK1";
		...
		//reloadMagazineSound[] = {"\FT_Titan_weapons\FT_Spitfire_MK1\sound\FT_Spitfire_MK1_reload.ogg",1,1,10};
		soundBullet[] = {};
...
class CfgVehicles
{
	...
	class FT_Spitfire_MK1_1: Weapon_Base_F
	{
		...
		{
			class FT_Spitfire_MK1_mag
			{
				magazine = "FT_40Rnd_Spitfire_MK1_Mag";
				count = 4;
			};
		};
	};
