class CfgPatches
{
	class FT_M1A1_Hemlock
	{
		units[] = {"FT_M1A1_Hemlock_w"};
		weapons[] = {"FT_M1A1_Hemlock"};
		requiRedVersion = 0.1;
		requiRedAddons[] = {"A3_Data_F","A3_Weapons_F"};
		magazines[] = {"FT_40Rnd_M1A1_Hemlock_Mag","FT_40Rnd_HE_M1A1_Hemlock_Mag"};
		ammo[] = {"FT_M1A1_Hemlock_ammo","FT_M1A1_Hemlock_ammo_HE"};
		author = "Leba";
	};
};
...
class CfgAmmo
{
	...
	class B_762x51_Ball;
	class FT_M1A1_Hemlock_ammo:B_762x51_Ball
	{
		hit=6;
	};
};
class CfgMagazines
{
	...
	class CA_Magazine;
	class FT_14Rnd_M1A1_Hemlock_Mag: CA_Magazine
	{
		author = "Leba";
		scope = 2;
		displayName = "14Rnd M1A1_Hemlock Mag";
		picture = "\A3\weapons_F\data\UI\m_20stanag_ca.paa";
		ammo = "FT_M1A1_Hemlock_ammo";
		count = 14;
		type = 16;
		initSpeed = 800;
		mass = 8;
	...
	class FT_14Rnd_M1A1_Hemlock_Mag_Tracer: FT_14Rnd_M1A1_Hemlock_Mag
	{
		author = "Leba";
		scope = 2;
		displayName = "14Rnd M1A1_Hemlock Mag(Tracer)";
		picture = "\A3\weapons_F\data\UI\m_20stanag_ca.paa";
		ammo = "FT_M1A1_Hemlock_ammo";
		tracersEvery = 0;
		lastRoundsTracer = 14;
...
class CfgWeapons
{
	...
	class FT_M1A1_Hemlock: FT_Rifle_Base
	{
		scope = 2;
		author = "Leba";
		FT_Weapon = "M1A1_Hemlock";
		FT_Ammo1 = "FT_14Rnd_M1A1_Hemlock_Mag";
		FT_Ammo2 = "FT_14Rnd_M1A1_Hemlock_Mag_Tracer";
		_generalMacro = "FT_M1A1_Hemlock";
		model = "\War_on_the_Frontier\FT_Weapons\FT_M1A1_Hemlock\FT_M1A1_Hemlock.p3d";
		//hiddenSelections[] = {"camo1","camo2","camo3"};
		//hiddenSelectionsTextures[] = {"\War_on_the_Frontier\FT_Weapons\FT_M1A1_Hemlock\data\ft_M1A1_Hemlock_camo1_co.paa","\War_on_the_Frontier\FT_Weapons\FT_M1A1_Hemlock\data\ft_M1A1_Hemlock_camo2_co.paa","\War_on_the_Frontier\FT_Weapons\FT_M1A1_Hemlock\data\ft_M1A1_Hemlock_camo3_co.paa"};
		handAnim[] = {"OFP2_ManSkeleton","\War_on_the_Frontier\FT_Weapons\FT_M1A1_Hemlock\animations\FT_M1A1_Hemlock_Hold.rtm"};
		reloadAction = "GestureReloadDMR06";//needs to have one for itself but i don't have time to make it
		picture = "";
		magazines[] = {"FT_14Rnd_M1A1_Hemlock_Mag","FT_14Rnd_M1A1_Hemlock_Mag_Tracer"};
		displayname = "M1A1_Hemlock";
		descriptionShort = "M1A1_Hemlock";
		...
		//reloadMagazineSound[] = {"\FT_Titan_weapons\FT_M1A1_Hemlock\sound\FT_M1A1_Hemlock_reload.ogg",1,1,10};
		soundBullet[] = {};
...
class CfgVehicles
{
	...
	class FT_M1A1_Hemlock_1: Weapon_Base_F
	{
		...
		{
			class FT_M1A1_Hemlock_mag
			{
				magazine = "FT_40Rnd_M1A1_Hemlock_Mag";
				count = 4;
			};
		};
	};
