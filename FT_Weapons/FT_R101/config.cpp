class CfgPatches
{
	class FT_R101
	{
		...
		magazines[] = {"FT_40Rnd_R101_Mag","FT_40Rnd_HE_R101_Mag"};
		ammo[] = {"FT_R101_ammo","FT_R101_ammo_HE"};
		author = "Leba";
	};
};
...
class CfgAmmo
{
	...
	class B_762x51_Ball;
	class FT_R101_ammo:B_762x51_Ball
	{
		hit=6;
	};
};
class CfgMagazines
{
	...
	class CA_Magazine;
	class FT_14Rnd_R101_Mag: CA_Magazine
	{
		author = "Leba";
		scope = 2;
		displayName = "14Rnd R101 Mag";
	...
	class FT_14Rnd_R101_Mag_Tracer: FT_14Rnd_R101_Mag
	{
		author = "Leba";
		scope = 2;
		displayName = "14Rnd R101 Mag(Tracer)";
		picture = "\A3\weapons_F\data\UI\m_20stanag_ca.paa";
		ammo = "FT_R101_ammo";
		tracersEvery = 0;
		lastRoundsTracer = 14;
...
class CfgWeapons
{
	...
	class FT_R101: FT_Rifle_Base
	{
		scope = 2;
		author = "Leba";
		FT_Weapon = "R101";
		FT_Ammo1 = "FT_14Rnd_R101_Mag";
		...
		picture = "";
		magazines[] = {"FT_14Rnd_R101_Mag","FT_14Rnd_R101_Mag_Tracer"};
		displayname = "R101";
		descriptionShort = "R101";
		...
		//reloadMagazineSound[] = {"\FT_Titan_weapons\FT_R101\sound\FT_R101_reload.ogg",1,1,10};
		soundBullet[] = {};
